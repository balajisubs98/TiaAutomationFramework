...
public class InvoiceListSD_BKT_Tires extends BaseUtility {
	...
	@Given("BKT_Tires Launch Tia application Dashboard by google chrome Browser {string} {string} {string}")
	...
	@Then("BKT_Tires Validate Purchase Order Label, MenuButton, Account name with Logo and Notification Bell Icon are available on Invoices listing page.")
	...
	@Then("BKT_Tires Validate Status Filter on Invoices listing page.")
...
//		li.add("DPH-H004");
	...
	@Then("BKT_Tires Validate PartnerOrg Filter on Invoices listing page.")
...
//		li.add("Aptiv Hugary : Szombathely");
	...
	@Then("BKT_Tires Validate Shows Entries on Invoices listing page.")
	...
	public void validate_sort_functionality_of_invoice_date_invoice_status_tax_and_grand_total_on_invoices_listing_page() throws InterruptedException {
		...
		System.out.println("sort"+equals);
			...
			sa.assertEquals(equals, true, "sort functionality");
	...
	@Then("BKT_Tires Invoice listing page Failures")
	...
	@Given("BKT_Tires Launch Tia application BKT_Tires Dashboard by google chrome Browser {string} {string} {string}")
	...
	@Then("BKT_Tires Validate Invoice Number, Invoice Date, Delivery Date, TG Transaction ID, Created Date, Invoice status, Allowance Total,and Payment Terms, label are available on Invoice Details Page.")
	...
	@Then("BKT_Tires Validate Allowance popup window, Print Invoice and Download Invoice.")
	...
	@Then("BKT_Tires Invoice details page Failures")
