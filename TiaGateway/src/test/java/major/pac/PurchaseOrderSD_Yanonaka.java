...
public class PurchaseOrderSD_Yanonaka extends BaseUtility {
	...
	@Given("Yanonaka Launch Tia application Dashboard On the google chrome Browser {string} {string} {string}")
	...
	@Then("Yanonaka Validate Purchase Order Label, MenuButton, Account name with Logo and Notification Bell Icon are available on Purchase Order list page.")
	...
	@Then("Yanonaka Validate Status Filter on Purchase Order list page.")
	...
	@Then("Yanonaka Validate PartnerOrg Filter on Purchase Order list page.")
	...
	@Then("Yanonaka Validate Shows Entries on Purchase Order list page.")
	...
	@Then("Yanonaka Purchase order listing page Failures")
	...
	@Given("Yanonaka Launch Tia application On the chrome Browser {string} {string} {string}")
	...
	@Then("Yanonaka Validate Ship To Label and Logo, Bill To Label and Logo, and PO status are available on the Purchase order details page.")
	...
	@Then("Yanonaka Validate Plus button on the purchase order details page.")
	...
	@Then("Yanonaka Validate Search module on the purchase order details page.")
...
//		ac.keyUp(Keys.ENTER).perform();
	...
	@Then("Yanonaka Validate product details table on the purchase order details page.")
	...
	@Then("Yanonaka purchase order details page Failures")
