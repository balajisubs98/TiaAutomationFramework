...
public class ShipmentListSD_Mutivista extends BaseUtility {
	...
	@Given("Multivista Launch Tia application Dashboard via google chrome Browser {string} {string} {string}")
	...
	@Then("Multivista Validate Purchase Order Label, MenuButton, Account name with Logo and Notification Bell Icon are available on Shipments list page.")
	...
	@Then("Multivista Validate Status Filter on Packing and Shipments list page.")
	...
	@Then("Multivista Validate PartnerOrg Filter on Packing and Shipments list page.")
	...
	@Then("Multivista Validate Shows Entries on Packing and Shipments list page.")
...
//		int n2 = 1;
	...
	@Given("Multivista Launch the Tia application on google chrome Browser {string} {string} {string}")
	...
	@When("Multivista Validate PO or Delfore number on Shipments Details Page.")
	...
	@Then("Multivista Validate Select Task Dropdown Print Shipping Label and Print Packing slip on Shipments Details Page.")
	...
	@Then("Multivista Validate Print ASN and Download ASN buttons on the Shipments Details Page.")
