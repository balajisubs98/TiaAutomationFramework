...
public class ShipmentListSD_Indica extends BaseUtility {
	...
	@Given("Indica Launch Tia application Dashboard via google chrome Browser {string} {string} {string}")
	...
	@Then("Indica Validate Purchase Order Label, MenuButton, Account name with Logo and Notification Bell Icon are available on Shipments list page.")
	...
	@Then("Indica Validate Status Filter on Packing and Shipments list page.")
	...
	@Then("Indica Validate PartnerOrg Filter on Packing and Shipments list page.")
	...
	@Then("Indica Validate Shows Entries on Packing and Shipments list page.")
...
//		int n2 = 1;
	...
	@Given("Indica Launch the Tia application on google chrome Browser {string} {string} {string}")
	...
	@When("Indica Validate PO or Delfore number on Shipments Details Page.")
	...
	@Then("Indica Validate Select Task Dropdown Print Shipping Label and Print Packing slip on Shipments Details Page.")
	...
	@Then("Indica Validate Print ASN and Download ASN buttons on the Shipments Details Page.")
