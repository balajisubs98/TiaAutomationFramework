...
public class ShipmentListSD_MTI extends BaseUtility {
	...
	@Given("MTI Launch Tia application Dashboard via google chrome Browser {string} {string} {string}")
	...
	@Then("MTI Validate Purchase Order Label, MenuButton, Account name with Logo and Notification Bell Icon are available on Shipments list page.")
	...
	@Then("MTI Validate Status Filter on Packing and Shipments list page.")
	...
	@Then("MTI Validate PartnerOrg Filter on Packing and Shipments list page.")
	...
	@Then("MTI Validate Shows Entries on Packing and Shipments list page.")
...
//		int n2 = 1;
	...
	@Given("MTI Launch the Tia application on google chrome Browser {string} {string} {string}")
	...
	@When("MTI Validate PO or Delfore number on Shipments Details Page.")
	...
	@Then("MTI Validate Select Task Dropdown Print Shipping Label and Print Packing slip on Shipments Details Page.")
	...
	@Then("MTI Validate Print ASN and Download ASN buttons on the Shipments Details Page.")
