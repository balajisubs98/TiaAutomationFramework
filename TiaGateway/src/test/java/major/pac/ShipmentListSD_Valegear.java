...
public class ShipmentListSD_Valegear extends BaseUtility {
	...
	@Given("Valegear Launch Tia application Dashboard via google chrome Browser {string} {string} {string}")
	...
	@Then("Valegear Validate Purchase Order Label, MenuButton, Account name with Logo and Notification Bell Icon are available on Shipments list page.")
	...
	@Then("Valegear Validate Status Filter on Packing and Shipments list page.")
	...
	@Then("Valegear Validate PartnerOrg Filter on Packing and Shipments list page.")
	...
	@Then("Valegear Validate Shows Entries on Packing and Shipments list page.")
...
//		int n2 = 1;
	...
	@Given("Valegear Launch the Tia application on google chrome Browser {string} {string} {string}")
	...
	@When("Valegear Validate PO or Delfore number on Shipments Details Page.")
	...
	@Then("Valegear Validate Select Task Dropdown Print Shipping Label and Print Packing slip on Shipments Details Page.")
	...
	@Then("Valegear Validate Print ASN and Download ASN buttons on the Shipments Details Page.")
