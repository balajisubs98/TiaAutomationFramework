...
public class PurchaseOrderSD_Tarson extends BaseUtility {
	...
	@Given("Tarson Launch Tia application Dashboard On the google chrome Browser {string} {string} {string}")
	...
	@Then("Tarson Validate Purchase Order Label, MenuButton, Account name with Logo and Notification Bell Icon are available on Purchase Order list page.")
	...
	@Then("Tarson Validate Status Filter on Purchase Order list page.")
	...
	@Then("Tarson Validate PartnerOrg Filter on Purchase Order list page.")
	...
	@Then("Tarson Validate Shows Entries on Purchase Order list page.")
	...
	@Then("Tarson Purchase order listing page Failures")
	...
	@Given("Tarson Launch Tia application On the chrome Browser {string} {string} {string}")
	...
	@Then("Tarson Validate Ship To Label and Logo, Bill To Label and Logo, and PO status are available on the Purchase order details page.")
	...
	@Then("Tarson Validate Plus button on the purchase order details page.")
	...
	@Then("Tarson Validate Search module on the purchase order details page.")
...
//		ac.keyUp(Keys.ENTER).perform();
	...
	@Then("Tarson Validate product details table on the purchase order details page.")
	...
	@Then("Tarson purchase order details page Failures")
