...
public class InvoiceListSD_Multivista extends BaseUtility {
	...
	@Given("Multivista Launch Tia application Dashboard by google chrome Browser {string} {string} {string}")
	...
	@Then("Multivista Validate Purchase Order Label, MenuButton, Account name with Logo and Notification Bell Icon are available on Invoices listing page.")
	...
	@Then("Multivista Validate Status Filter on Invoices listing page.")
...
//		li.add("DPH-H004");
	...
	@Then("Multivista Validate PartnerOrg Filter on Invoices listing page.")
...
//		li.add("Aptiv Hugary : Szombathely");
	...
	@Then("Multivista Validate Shows Entries on Invoices listing page.")
	...
	@Then("Multivista Invoice listing page Failures")
	...
	@Given("Multivista Launch Tia application Multivista Dashboard by google chrome Browser {string} {string} {string}")
	...
	@Then("Multivista Validate Invoice Number, Invoice Date, Delivery Date, TG Transaction ID, Created Date, Invoice status, Allowance Total,and Payment Terms, label are available on Invoice Details Page.")
	...
	@Then("Multivista Validate Allowance popup window, Print Invoice and Download Invoice.")
	...
	@Then("Multivista Invoice details page Failures")
