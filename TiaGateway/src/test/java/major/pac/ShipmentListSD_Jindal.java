...
public class ShipmentListSD_Jindal extends BaseUtility {
	...
	@Given("Jindal Launch Tia application Dashboard via google chrome Browser {string} {string} {string}")
	...
	@When("Jindal Validate Order To Cash --> Send Shipments --> Shipment list Option Available on under the Menu.")
	...
	@Then("Jindal Validate After clicks Shipment list option, it navigates to Packing and Shipments list page.")
	...
	@Then("Jindal Validate Purchase Order Label, MenuButton, Account name with Logo and Notification Bell Icon are available on Shipments list page.")
	...
	@Then("Jindal Validate From Date Filter and To Date Filter on Shipments list page.")
	...
	@Then("Jindal Validate Status Filter on Packing and Shipments list page.")
	public void validate_status_filter_on_packing_and_shipments_list_page()
		...
		for (int i = 0; i < li.size(); i++) {
			...
			sp.getStatusFiltersearchMV().sendKeys(li.get(i));
			Robot r = new Robot();
			r.keyPress(KeyEvent.VK_ENTER);
			r.keyRelease(KeyEvent.VK_ENTER);
			Thread.sleep(5000);
	...
	@Then("Jindal Validate Receiver Filter on Packing and Shipments list page.")
	public void validate_receiver_filter_on_packing_and_shipments_list_page()
		...
		for (int i = 0; i < li.size(); i++) {
			...
			sp.getRecvFiltersearchMV().sendKeys(li.get(i));
			Robot r = new Robot();
			r.keyPress(KeyEvent.VK_ENTER);
			r.keyRelease(KeyEvent.VK_ENTER);
			Thread.sleep(5000);
	...
	@Then("Jindal Validate PartnerOrg Filter on Packing and Shipments list page.")
	public void validate_partner_org_filter_on_packing_and_shipments_list_page()
		...
		for (int i = 0; i < li.size(); i++) {
			...
			sp.getPartorgFiltersearchMV().sendKeys(li.get(i));
			Robot r = new Robot();
			r.keyPress(KeyEvent.VK_ENTER);
			r.keyRelease(KeyEvent.VK_ENTER);
			Thread.sleep(5000);
	...
	@Then("Jindal Validate Partner Filter on Packing and Shipments list page.")
	public void validate_partner_filter_on_packing_and_shipments_list_page()
		...
		for (int i = 0; i < li.size(); i++) {
			...
			sp.getPartnerFiltersearchMV().sendKeys(li.get(i));
			Robot r = new Robot();
			r.keyPress(KeyEvent.VK_ENTER);
			r.keyRelease(KeyEvent.VK_ENTER);
			Thread.sleep(5000);
	...
	@Then("Jindal Validate Serach Text Box on Packing and Shipments list page.")
	public void validate_serach_text_box_on_packing_and_shipments_list_page()
			throws IOException, AWTException, InterruptedException {
		po = new PurchaseOrderPOM();
		sp = new ShipmentListPOM();
		JavascriptExecutor js = (JavascriptExecutor) driver;
		String ValidData = "ASN22089";
	...
	@Then("Jindal Validate the Select Action on Packing and Shipments list page.")
	...
	@Then("Jindal Validate Shows Entries on Packing and Shipments list page.")
	...
	@Then("Jindal Validate sort functionality of ASN number, ASN Date,and ASN Stauts on Packing and Shipments list page.")
...
//		int n2 = 1;
	...
	@Given("Jindal Launch the Tia application on google chrome Browser {string} {string} {string}")
	...
	@When("Jindal Validate Order To Cash --> Receive Orders --> Order list--> Select a PO from list --> click >>button should be reach Shipments Details Page.")
	...
	@When("Jindal Validate PO or Delfore number on Shipments Details Page.")
	...
	@Then("Jindal Validate Barcode number, ASN Date, ASN status, ASN Date, Created Date, Shipment ID, Shipment Date, Delivery Date, Transport Type, Autopack, ShipFrom, ShipTo, Tracking NO and AWB No label are available on Shipments Details Page.")
	...
	@Then("Jindal Validate Select Task Dropdown Print Shipping Label and Print Packing slip on Shipments Details Page.")
	...
	@Then("Jindal Validate Product Table on Shipments Details Page.")
	...
	@Then("Jindal Validate Print ASN and Download ASN buttons on the Shipments Details Page.")
