...
public class ShipmentListSD_Rexel extends BaseUtility {
	...
	@Given("Rexel Launch Tia application Dashboard via google chrome Browser {string} {string} {string}")
	...
	@Then("Rexel Validate Purchase Order Label, MenuButton, Account name with Logo and Notification Bell Icon are available on Shipments list page.")
	...
	@Then("Rexel Validate Status Filter on Packing and Shipments list page.")
	...
	@Then("Rexel Validate PartnerOrg Filter on Packing and Shipments list page.")
	...
	@Then("Rexel Validate Shows Entries on Packing and Shipments list page.")
...
//		int n2 = 1;
	...
	@Given("Rexel Launch the Tia application on google chrome Browser {string} {string} {string}")
	...
	@When("Rexel Validate PO or Delfore number on Shipments Details Page.")
	...
	@Then("Rexel Validate Select Task Dropdown Print Shipping Label and Print Packing slip on Shipments Details Page.")
	...
	@Then("Rexel Validate Print ASN and Download ASN buttons on the Shipments Details Page.")
