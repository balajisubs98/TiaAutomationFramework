...
public class InvoiceListSD_Valegear extends BaseUtility {
	...
	@Given("Valegear Launch Tia application Dashboard by google chrome Browser {string} {string} {string}")
	...
	@Then("Valegear Validate Purchase Order Label, MenuButton, Account name with Logo and Notification Bell Icon are available on Invoices listing page.")
	...
	@Then("Valegear Validate Status Filter on Invoices listing page.")
...
//		li.add("DPH-H004");
	...
	@Then("Valegear Validate PartnerOrg Filter on Invoices listing page.")
...
//		li.add("Aptiv Hugary : Szombathely");
	...
	@Then("Valegear Validate Shows Entries on Invoices listing page.")
	...
	@Then("Valegear Invoice listing page Failures")
	...
	@Given("Valegear Launch Tia application Interplex Dashboard by google chrome Browser {string} {string} {string}")
	...
	@Then("Valegear Validate Invoice Number, Invoice Date, Delivery Date, TG Transaction ID, Created Date, Invoice status, Allowance Total,and Payment Terms, label are available on Invoice Details Page.")
	...
	@Then("Valegear Validate Allowance popup window, Print Invoice and Download Invoice.")
	...
	@Then("Valegear Invoice details page Failures")
