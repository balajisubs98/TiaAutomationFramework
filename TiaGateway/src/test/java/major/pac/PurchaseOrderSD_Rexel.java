...
public class PurchaseOrderSD_Rexel extends BaseUtility {
	...
	@Given("Rexel Launch Tia application Dashboard On the google chrome Browser {string} {string} {string}")
	...
	@Then("Rexel Validate Purchase Order Label, MenuButton, Account name with Logo and Notification Bell Icon are available on Purchase Order list page.")
	...
	@Then("Rexel Validate Status Filter on Purchase Order list page.")
	...
	@Then("Rexel Validate PartnerOrg Filter on Purchase Order list page.")
	...
	@Then("Rexel Validate Shows Entries on Purchase Order list page.")
	...
	@Then("Rexel Purchase order listing page Failures")
	...
	@Given("Rexel Launch Tia application On the chrome Browser {string} {string} {string}")
	...
	@Then("Rexel Validate Ship To Label and Logo, Bill To Label and Logo, and PO status are available on the Purchase order details page.")
	...
	@Then("Rexel Validate Plus button on the purchase order details page.")
	...
	@Then("Rexel Validate Search module on the purchase order details page.")
...
//		ac.keyUp(Keys.ENTER).perform();
	...
	@Then("Rexel Validate product details table on the purchase order details page.")
	...
	@Then("Rexel purchase order details page Failures")
