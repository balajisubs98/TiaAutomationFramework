...
public class ShipmentListSD_Yanonaka extends BaseUtility {
	...
	@Given("Yanonaka Launch Tia application Dashboard via google chrome Browser {string} {string} {string}")
	...
	@Then("Yanonaka Validate Purchase Order Label, MenuButton, Account name with Logo and Notification Bell Icon are available on Shipments list page.")
	...
	@Then("Yanonaka Validate Status Filter on Packing and Shipments list page.")
	...
	@Then("Yanonaka Validate PartnerOrg Filter on Packing and Shipments list page.")
	...
	@Then("Yanonaka Validate Shows Entries on Packing and Shipments list page.")
...
//		int n2 = 1;
	...
	@Given("Yanonaka Launch the Tia application on google chrome Browser {string} {string} {string}")
	...
	@When("Yanonaka Validate PO or Delfore number on Shipments Details Page.")
	...
	@Then("Yanonaka Validate Select Task Dropdown Print Shipping Label and Print Packing slip on Shipments Details Page.")
	...
	@Then("Yanonaka Validate Print ASN and Download ASN buttons on the Shipments Details Page.")
